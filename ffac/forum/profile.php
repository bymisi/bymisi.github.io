			...
			<form id="profile3" method="post" action="profile.php?section=messaging&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<input type="hidden" name="form_sent" value="1" />
							<label><?php echo $lang_profile['ICQ'] ?><br /><input id="icq" readonly="readonly" type="text" name="form[icq]" value="<?php echo $user['icq'] ?>" size="24" maxlength="24" /><br /></label>
